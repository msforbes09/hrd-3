...
<div class="row">
	...
	<div class="col-lg-8">
		<div class="input-group">
			<select class="form-control" id="text_staff" style="padding-left: 16px;" <?php if($stat != null){ echo 'tabindex="-1" disabled'; } ?>>
				<?php echo get_staff_list($team_id,$staff,$staff_id); ?>
			</select>
