...
$time_in = $row[$index . "_in"];
$time_out = $row[$index . "_out"];
...
<div class="row">
	...
	<div class="col-lg-4">
		<div class="input-group">
			<input type="text" id="in_txt" value="<?php echo $time_in; ?>" class="form-control" style="padding-left: 20px; text-transform:uppercase; background-color: white;" tabindex="-1" disabled />
			<span class="input-group-addon in_btn time_in">
	...
	<div class="col-lg-4">
		<div class="input-group">
			<input type="text" id="out_txt" value="<?php echo $time_out; ?>" class="form-control" style="padding-left: 20px; text-transform:uppercase; background-color: white;" tabindex="-1" disabled />
			<span class="input-group-addon out_btn">
				<span class="glyphicon glyphicon-time"></span>
			</span>
		</div>
	</div>
